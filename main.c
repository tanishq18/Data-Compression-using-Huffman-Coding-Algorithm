...
printf("Hi!!\nNamaste!\n");
printf("Welcome to Tanishq's huffman compressor\n");
printf("Type the name of the file which you want to process...\n");
scanf("%s",filename);
printf("Press 1 to compress and 2 to decompress...\n");
scanf("%d",&compress);
